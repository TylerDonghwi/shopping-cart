    ...
    return (
        <div className='m-2 border shadow-md rounded-md'>
            ...
            <div className='mt-auto w-[100%]'>
                {quantity === 0 ? (
                    <button className='relative text-white rounded-sm p-1 bg-blue-500 w-[calc(100%-1rem)] m-2 hover:bg-blue-600 active:bg-blue-700 transition-all duraction-100'>
                        + Add To Cart
                    </button>
                ) : (
                    <div className='flex flex-col justify-center items-center m-2'>
                        <div className='flex flex-row justify-center items-center w-[100%] mb-2 [&>*]:mx-2 [&>button]:w-8'>
                            <button className='relative text-white rounded-sm p-1 bg-blue-500 hover:bg-blue-600 active:bg-blue-700'>
                                -
                            </button>
                            <div>
                        ...
                        <button className='relative text-white rounded-sm p-1 bg-red-500 w-[25%]  hover:bg-red-600 active:bg-red-700 transition-all duraction-100'>
                            Remove
                        </button>
                    </div>)}
            </div>
